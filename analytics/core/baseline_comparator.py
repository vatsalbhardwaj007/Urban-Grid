...
METRIC_DIRECTION_REGISTRY: dict[str, MetricDirection] = {
    ...
    "vehicle_count": MetricDirection.HIGHER_IS_BETTER,
...
class MetricComparison:
    ...
    Attributes:
        ...
        direction: Metric directionality ('lower_is_better' or 'higher_is_better').
        is_improved: Boolean flag indicating if Urban Grid outperformed Baseline.
    """
...
def calculate_percentage_improvement(
    ...
    Args:
        ...
        direction: MetricDirection enum indicating if higher or lower is better.
...
def compare_metric(
    ...
    if dir_enum == MetricDirection.LOWER_IS_BETTER:
